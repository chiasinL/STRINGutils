...
The default number of proteins obtained from the network is set to 200. This number can be change with `n_hits`. The network view mode for STRING network can also be
