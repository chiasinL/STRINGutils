...
The *default* number of proteins obtained from the network is set to 200. This number can be change with *n_hits*. 

For example, to increase the number of proteins in the network to 500:
